...
class PatchTrainer(object):
    def __init__(self, mode):
        ...
        self.darknet_model_1 = Darknet(self.config.cfgfile)
        self.darknet_model_1.load_weights(self.config.weightfile)
        self.darknet_model_1 = self.darknet_model_1.eval().cuda()
        ...
        for epoch in range(n_epochs):
            ...
            for i_batch, (img_batch, lab_batch) in tqdm(enumerate(train_loader), desc=f'Running epoch {epoch}',
                ...
                with autograd.detect_anomaly():
                    ...
                    output_1 = self.darknet_model_1(p_img_batch)
                    max_prob_1 = self.prob_extractor(output_1)
                    ...
                    nps_loss = nps*0.01
                    tv_loss = tv*2.5
                    det_loss = torch.mean(max_prob)+torch.mean(max_prob_1)
